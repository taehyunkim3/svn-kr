...
@Test func documentOpenPromptUsesASheetWithAnOpenWithoutLockOnlyCheckbox() throws {
    ...
    #expect(confirmation.contains(".ui.lock.openWithoutLockingDonTAskAgain"))
...
@Test func documentOpenSettingsOfferThreePoliciesAndConditionTheWarning() throws {
    ...
    #expect(settings.contains(".ui.settings.otherUsersCannotModifyLockedFileUntilCommitItRelease"))
}
