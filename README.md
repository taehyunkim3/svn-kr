...
소스에서 실행하려면 macOS 14 이상, Xcode 16 이상, SVN CLI가 필요합니다. `dist/SVN for Mac.app`을 사용하는 일반 사용자는 Xcode, Homebrew, SVN이 필요하지 않습니다.
...
생성된 `dist/SVN-for-Mac-버전-app-store.pkg`는 Transporter로 App Store Connect에
